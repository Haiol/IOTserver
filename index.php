...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <span class="circleBar-label blue"><i class="fa fa-thermometer-half" aria-hidden="true"></i> Temperature</span>
                                            <!-- ******************** -->
                                            <div class= "circleBar blue">
                                                <div class="round_temp"
                                                data-value=
                                                <?php
                                                echo '"'.($temp*0.01).'"';
                                                ?>
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                        <span class="circleBar-label yellow"><i class="fa fa-tint" aria-hidden="true"></i> Humidity</span>
                                              <!-- ******************** -->
                                              <div class= "circleBar yellow">
                                              <div class="round_hum"
                                                data-value=
                                                <?php
                                                echo '"'.($hum*0.01).'"';
    ...
    <script  for="simplelineChart">
                <?php
        $sql3 = "select ROUND(avg(temp),1) as 'temp', ROUND(avg(humm),1) as 'humm', DATE_FORMAT(create_date, '%y-%m-%d') as 'create_date' from datawave where user_code= ".$_SESSION['user_code']." group by DATE_FORMAT(create_date, '%Y-%m-%d') ORDER BY create_date
        DESC LIMIT 20;";
